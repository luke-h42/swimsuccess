...
<h1 className="text-2xl font-bold text-center mb-4 text-baseblack">Welcome!</h1>
                <form>
                <div className="mb-4">
                        <label htmlFor="name" className="block text-sm font-medium text-neutral-700 mb-2">Name</label>
                        <input type="name" id="name" className="shadow-sm rounded-md w-full px-3 py-2 border border-primary600 focus:outline-none focus:ring-primary100 focus:border-primary" placeholder="Enter your name" required />
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4 flex flex-col">
                        ...
                        <Link to='/login' className="block text-sm font-medium text-neutral-700 mt-2 place-self-end underline hover:text-primary">Got an account?</Link>
                    </div>
